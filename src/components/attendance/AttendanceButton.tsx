      ...
      <AnimatePresence>
        {showModal && (
          <div className="fixed inset-0 z-[9999] md:flex md:items-center md:justify-center md:p-4">
            ...
            >
              {/* כותרת החלון */}
              <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-600 to-purple-600 px-4 md:px-6 py-3 md:py-4 flex justify-between items-center shadow-lg">
                ...
                <motion.button
                  ...
                  className="w-6 h-6 md:w-8 md:h-8 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg flex items-center justify-center text-white transition-all"
                >
              ...
              <div className="flex-1 overflow-y-auto h-full p-4 md:p-6">
                ...
                <div className="mb-4 md:mb-6">
                  <motion.div
                    ...
                    className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 rounded-xl md:rounded-2xl p-4 md:p-6 border-2 border-blue-200 dark:border-blue-800 shadow-lg"
                  >
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-2 md:gap-3 mb-2 md:mb-3">
                        ...
                        <h3 className="text-lg md:text-xl font-bold text-blue-800 dark:text-blue-200">
                          סה"כ שעות עבודה בחודש
                        </h3>
                      </div>
                      <div className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400">
                        {Number(totalHours).toFixed(2)}
                      </div>
                      <p className="text-sm md:text-base text-blue-600 dark:text-blue-300 mt-1 md:mt-2 font-medium">
                        שעות
                      </p>
                    </div>
                  </motion.div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-4 md:gap-6 w-full mr-4">
                      <div className="relative w-full lg:w-auto">
                        <motion.button
                          ...
                          disabled={isLoading}
                          className={`w-full pl-4 md:pl-5 pr-12 md:pr-14 py-3 md:py-4 border-2 rounded-xl md:rounded-2xl font-medium text-sm md:text-lg haptic-heavy ${
                      ...
                      {currentSession && (
                        <motion.div
                          ...
                          className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl md:rounded-2xl p-3 md:p-5 shadow-lg border border-blue-200 dark:border-blue-800 w-full lg:w-auto"
                        >
                          <p className="text-sm md:text-base font-bold text-blue-800 dark:text-blue-200 text-center lg:text-right">
                            התחלת משמרת:{' '}
                            {format(
                          ...
                          <p className="text-sm md:text-base font-bold text-blue-800 dark:text-blue-200 mt-1 md:mt-2 text-center lg:text-right">
                      ...
                      <div className="relative w-full lg:w-auto">
                        ...
                        <input
                          ...
                          className="w-full pl-4 md:pl-5 pr-12 md:pr-14 py-3 md:py-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl md:rounded-2xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-medium text-sm md:text-lg"
                        />
                      </div>
                    </div>
                  </div>
