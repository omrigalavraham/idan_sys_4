        ...
        {showModal && (
          <div className="fixed inset-0 z-[9999] md:flex md:items-center md:justify-center md:p-4">
            ...
            <motion.div
              ...
              className="fixed inset-0 md:relative md:inset-auto bg-white dark:bg-gray-900 md:max-w-5xl md:max-h-[85vh] md:rounded-2xl shadow-2xl border-0 md:border border-gray-200 dark:border-gray-700 overflow-auto flex flex-col z-[10000]"              onClick={e => e.stopPropagation()}
            >
              {/* כותרת החלון */}
