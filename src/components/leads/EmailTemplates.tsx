...
const EmailTemplates: React.FC<EmailTemplatesProps> = ({
  ...
  const templates = [
    ...
    ...clientTemplates.map(t => ({
      ...
      subject: t.subject || '',
      message: (name: string) =>
        t.content.replace(/{name}/g, name).replace(/{email}/g, email),
    })),
  ];
                        ...
                        >
                          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl border-2 border-blue-200 dark:border-blue-800">
                            ...
                            <input
                              ...
                              className="w-full mb-3 px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                            />
                            <textarea
                              value={customMessage}
                            ...
                            {(customSubject || customMessage) && (
                              <motion.button
                                ...
                                className="w-full mt-4 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium flex items-center justify-center gap-2 shadow-lg transition-all"
                              >
                          ...
                          {isSelected && (
                            ...
                            >
                              <div className="border-t border-gray-200 dark:border-gray-600 pt-3 mt-3">
                                ...
                                <p className="text-xs text-gray-600 dark:text-gray-400 mb-3 whitespace-pre-line leading-relaxed">
                              ...
                              <motion.button
                                ...
                                className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium text-sm flex items-center justify-center gap-2 shadow-md transition-colors"
                              >
