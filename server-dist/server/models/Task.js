...
export class TaskModel {
    ...
    static async create(taskData) {
       ...
       RETURNING 
         ...
         created_at, updated_at, notified`, [title, description, status, priority, due_date, assigned_to, lead_id, customer_id, created_by]);
    ...
    static async update(id, updates) {
       ...
       RETURNING 
         ...
         TO_CHAR(due_date, 'YYYY-MM-DD"T"HH24:MI:SS') as due_date,
         assigned_to, lead_id, customer_id, created_by, 
         created_at, updated_at, notified`, values);
        return result.rows[0] || null;
    }
    // Delete task
    ...
    static async findByStatus(status) {
        ...
        assigned_to, lead_id, customer_id, created_by, 
        created_at, updated_at, notified
      FROM tasks WHERE status = $1 ORDER BY due_date ASC`, [status]);
        return result.rows;
    }
    ...
    static async findByAssignedTo(assignedTo) {
        ...
        assigned_to, lead_id, customer_id, created_by, 
        created_at, updated_at, notified
      FROM tasks WHERE assigned_to = $1 ORDER BY due_date ASC`, [assignedTo]);
        return result.rows;
    }
    ...
    static async findByLeadId(leadId) {
        ...
        assigned_to, lead_id, customer_id, created_by, 
        created_at, updated_at, notified
      FROM tasks WHERE lead_id = $1 ORDER BY due_date ASC`, [leadId]);
        return result.rows;
    }
    ...
    static async findByCustomerId(customerId) {
        ...
        assigned_to, lead_id, customer_id, created_by, 
        created_at, updated_at, notified
      FROM tasks WHERE customer_id = $1 ORDER BY due_date ASC`, [customerId]);
        return result.rows;
    }
    // Get overdue tasks
    static async findOverdue() {
        ...
        assigned_to, lead_id, customer_id, created_by, 
        created_at, updated_at, notified
      FROM tasks WHERE due_date < CURRENT_TIMESTAMP AND status != $1 ORDER BY due_date ASC`, ['הושלם']);
        return result.rows;
    }
    // Get tasks due today
